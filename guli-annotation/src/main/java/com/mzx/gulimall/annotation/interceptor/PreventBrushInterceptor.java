package com.mzx.gulimall.annotation.interceptor;

import com.alibaba.fastjson.JSON;
import com.mzx.gulimall.annotation.AccessLimit;
import com.mzx.gulimall.annotation.constant.RedisConstant;
import com.mzx.gulimall.annotation.service.IAccessLimitService;
import com.mzx.gulimall.annotation.utils.IpUtil;
...
/**
 * 向引入该guli-annotation服务的IOC容器中添加一个拦截器.
 * 到时候只需要在引入该服务的WebMVC的配置文件中注册一个该拦截器即可实现接口防刷.
 *
 * @author ZhenXinMa.
 * @slogan 脚踏实地向前看.
 * @create 2020-09-25 20:39 周五.
 */
@Component
